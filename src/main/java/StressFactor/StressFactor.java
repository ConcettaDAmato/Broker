...
public abstract class StressFactor {
	...
	public StressFactor (double[] thetaWp, double[] thetaFc, double[] z, double[] deltaZ, int NUM_CONTROL_VOLUMES, double totalDepth) {
		...
		//this.zR = totalDepth + etaR;
		//this.zE = totalDepth + etaE;
